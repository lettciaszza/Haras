...
public class ComboBoxSuggestionUI extends BasicComboBoxUI{
    ...
    public void installUI(JComponent jc) {
        ...
        txt.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(255, 154, 99));
            }

            @Override
            public void focusLost(FocusEvent fe) {
                border.setColor(new Color(245, 227, 211));
            }
        });
        comboBox.addPopupMenuListener(new PopupMenuListener() {
            @Override
            public void popupMenuWillBecomeVisible(PopupMenuEvent pme) {
                arrowButton.setBackground(new Color(245, 227, 211));
            }
        ...
        txt.setSelectionColor(new Color(255, 154, 99,70));
        ...
        return new ListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList jlist, Object e, int i, boolean bln, boolean bln1) {
                ...
                if (bln) {
                    ...
                    label.setForeground(new Color(255, 104, 13));
                }
                return label;
            }
        };
    ...
    private class ArrowButton extends JButton {
        ...
        public ArrowButton() {
            ...
            setBackground(new Color(255, 154, 99));
        }
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = new Color(255, 154, 99);
        private Color color = new Color(245, 227, 211);
