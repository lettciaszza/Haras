...
public class MyFormattedTextField extends JFormattedTextField {
    ...
    public MyFormattedTextField() {
        ...
        setForeground(Color.decode("#4A2514"));//font color
        setFont(new java.awt.Font("sansserif", 0, 13));
        setSelectionColor(new Color(225, 200, 183));
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.setColor(new Color(245, 227, 211));//background
    ...
    public void paint(Graphics g) {
        ...
        if (getText().length() == 0) {
            ...
            g.setColor(new Color(148, 114, 90));
